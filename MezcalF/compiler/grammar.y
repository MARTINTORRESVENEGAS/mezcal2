...
%token  NAME COLON RIGHT_ARROW LEFT_CURLY_BRACE RIGHT_CURLY_BRACE SEMICOLON LEFT_PARENTHESIS RIGHT_PARENTHESIS SINGLECOMMENT 
	MULTILINECOMMENT SHOW QUOTES CHARACTERS_BLOCK INT INTEGER_VALUE DECIMAL_VALUE LOAD STDIN DOLLAR_SIGN INCREMENTO DECREMENTO DEC 		BLN SET TRU FLS ITOB IF LEFT_BRACKET RIGHT_BRACKET EQ LE LT GT GE NE ELSE COMA STR DOBLE_COLON WHILE ANSWER PLUS SLASHI MINUS 		SLASH
%start input
