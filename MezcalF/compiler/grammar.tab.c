...
static const yytype_int16 yyrline[] =
{
      ...
      60,    62,    64,    66,    68,    70,    72,    74,    76,    81,
      83,    85,    87,    92,    94,    97,   100,   103,   106,   112,
     115,   118,   120,   122,   126,   128,   130,   132,   134,   136,
     141,   143,   145,   147,   149,   151,   153,   155,   158,   161,
     164,   167,   170,   172,   174,   176,   178,   180,   183,   185,
     187,   189,   194,   198,   202,   204,   208,   212,   218,   224,
     226,   228,   230,   232,   236,   238,   242,   246,   250,   252,
     254,   256,   258,   260,   264,   268,   272
};
#endif
...
static const char *const yytname[] =
{
  ...
  "LOAD", "STDIN", "DOLLAR_SIGN", "INCREMENTO", "DECREMENTO", "DEC", "BLN",
  "SET", "TRU", "FLS", "ITOB", "IF", "LEFT_BRACKET", "RIGHT_BRACKET", "EQ",
  "LE", "LT", "GT", "GE", "NE", "ELSE", "COMA", "STR", "DOBLE_COLON",
  "WHILE", "ANSWER", "PLUS", "SLASHI", "MINUS", "SLASH", "$accept",
  "input", "function_list", "function", "statements", "statement",
  "bifurcation", "loop", "logical_eval", "comp_operator", "assignment",
  "integer_value", "decimal_value", "unitaryOperations", "std_input",
